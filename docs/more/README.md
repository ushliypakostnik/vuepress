...
Теперь стор знает о типоразмере которому в данный момент соответсвует вьюпорт. Вы можете добавлять любые поля и логику в модуль.

Когда мы работаем с реактивным фреймворком речь идет о достаточно лаконично и четко организованной поставленной системе. И чтобы она дейтсвительно работало «как часы» - не стоит ничего слишком усложнять! Я вижу это так, что у нас есть только: 
