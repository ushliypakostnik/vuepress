...
Обратите внимание на метод <code>designVersion()</code> оборачивающий адреса до ресурсов и позволяющий «передернуть» все картинки закэшированные на клиентах простым увеличением индекса в конфигурации:
