...
Но ведь в плане разметки интерфейса, ваша задача, как уже говорилось выше, как раз в том и состоит, чтобы эффективно перевести проект с _дизайнерского языка_ статичных графических прототипов на язык именно четких формальных абстракций, и в конечном итоге - примитивной декларативной разметки для браузера, которая будет вести себя динамично. Вам _нужно все понимать_, даже если автор макета сам не понимает.
