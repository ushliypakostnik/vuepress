...
С React все более прозаично - у нас просто есть папка <code>@/src/scss/components/</code> в которой мы складируем стили отдельных компонентов, которые, если это необходимо - просто используют стилевую базу. Вот - самый простой компонент - <code>Loader</code>, для примера, стили:
...
Сам компонент, в <code>@/src/components/utils/Loader.jxs</code>:
