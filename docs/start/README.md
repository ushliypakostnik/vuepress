...
На самом деле ведь очень просто и четко - если цель связывания - воздействие на компонент - отдаем стили ему. Если цель - использование компонента в неком обособленном контексте - пишем в этот выделенный код. Если вы все поймете и сделаете правильно - идеальная компонентность не будет нарушаться при таких связываниях.
