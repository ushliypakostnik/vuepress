...
Если же речь идет о разметке конкретного отдельного вида [а не «модификации на уровне всего интерфейса»], определенно правильно будет использовать стили именно этого конкретного вида:
```html
<main role="main">
