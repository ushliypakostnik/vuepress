...
Необходимо упомянуть, что некоторые разработчики применяют простую технологию [CSS Modules](https://github.com/css-modules/css-modules) для защиты стилей препроцессора в компонентах React. Но мне она кажется просто чудовищной по стилю, и совершенно точно излищней для небольших систем.
