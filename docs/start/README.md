...
Таким образом, даже если мы отменим хещирование стилей для Header, все равно специфичность голого тага-элемента с атрибутом **ul[data-v-xxxxxxxx]** из левого хеша от Layout оказывается выше чем у простого селектора по классу. Также, можно наблюдать «наслоение правил от стилевой базы» которое дает компонентность.
