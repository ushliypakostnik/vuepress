...
Давайте разберемся как определять отношения между более высокоурневыми астракциями и низкоуровневыми функциональными модулями не нарушая идеальной компонентности и изоляции. Ведь делать это почти всегда все равно необходимо.
