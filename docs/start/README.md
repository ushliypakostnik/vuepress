...
* Не оправдывают затрат и очень часто все равно не решают всеx проблем, не способны удовлетворять часто меняющиеся требованиям.
