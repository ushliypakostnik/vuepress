...
```scss
// Смотря где удобнее и логичнее это сделать - в самом селекторе или в обертке:
...
Старайтесь оставлять комментарии к каждому нетрифиальному или специфическому месту, которое потенциально способно вызвать у вас затруднения, когда вы вернетесь к нему в будущем.
