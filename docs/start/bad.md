...
Но еще со времен когда я часто использовал Bootstrap 3, у меня остался пассаж с обычно осуждаемым), но на самом деле очень полезным флагом **!important** [тут, напримиер, с ним надежнее], который предоставляет более «грубое и внешнее» решение - набор, созданных с помощью адаптивных примесей, утилитарных классов для включения прямо в разметку шаблонов:
