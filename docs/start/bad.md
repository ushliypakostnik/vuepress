...
Но еще со времен когда я часто использовал Bootstrap 3, у меня остался пассаж с осуждаемым ) обычно флагом **!important**, но так надежнее, который предоставляет более «грубое и внешнее» решение, набор утилитарных классов для включения прямо в разметку шаблонов:
...
В принипе, это все что нужно знать для того чтобы начать делать адаптивную верстку.